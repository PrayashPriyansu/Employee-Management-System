...
function DatePicker({ date, setDate }) {
  ...
  return (
    <input
      ...
      className="w-1/4 p-2 mt-2 mb-4 transition-all border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
    />
  );
}
